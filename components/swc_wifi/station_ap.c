...
static int s_retry_connect_num = 0;
...
void wifi_init_sta(void)
{
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ...
        ESP_LOGI(TAG, "Failed to connect to SSID:%s , Reestarting ESP32",
                WIFI_SSID);
...
void wifi_comp_init(){
    ...
    //Initialize Non-Volatile Storage to store key-value pairs. 
    //Needed for some func like esp_wifi_init to store/read info.
